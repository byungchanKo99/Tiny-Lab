...
```
      ...
      │ gen  │ │ script │ │surface │ │ _json   │ │.jsonl  │
...
```
  ...
  │                   dispatch_run()                      │
  │  ┌──────────┐  ┌──────────┐  ┌──────────────────┐   │
  │  │ command  │  │ surface  │  │    pipeline      │   │
  │  │ direct   │  │ via bin/ │  │ multi-step +     │   │
  │  │ shell    │  │ surface  │  │ background tasks │   │
  │  └──────────┘  └──────────┘  └──────────────────┘   │
  └──────────────────────────────────────────────────────┘
...
| `run.py`                | Plugin   | Run dispatching (command/surface/pipeline)    |
